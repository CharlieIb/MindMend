...
from app import app
from app.forms import ChooseForm, LoginForm, ChangePasswordForm, RegisterForm, FormRedirect, SelectSymptomsForm, generate_form,AnswerQuestionnaireForm
...
def select_symptoms():
    ...
    form.symptoms.choices = symptom_list # Load symptoms from database
    selected_symptoms = []
...
def answer_questionnaire():
    ...
    # Create Flask Forms
    generate_form(session['questionnaires'])
